...
public class CharacterCard : MonoBehaviour {
    ...
    public SpriteRenderer m_BackgroundRenderer = null;
    ...
    private SpriteRenderer m_CardFrameWorkRenderer = null;
    ...
    public void OnCardInAction()
    {
        if (m_CharacterCardVisualizer.GetVisualizeEffectStatus() == CardVisualizeEffect.VisualizeEffectStatus.Idle)
        {
            m_CharacterCardVisualizer.OnCardInAction(ref m_BackgroundRenderer);
        }
    }

    public void OnCardSelectedInTarget()
    {
        if(m_CharacterCardVisualizer.GetVisualizeEffectStatus() == CardVisualizeEffect.VisualizeEffectStatus.Idle)
        {
            m_CharacterCardVisualizer.OnCardSelectedInTarget(ref m_BackgroundRenderer);
        }
    }
    ...
    public bool IsContainPoint(ref Vector3 point)
    {
        return m_CardFrameWorkRenderer.bounds.Contains(point);
    }

    public void ForceQuitVisualizeEffect()
    {
        m_CharacterCardVisualizer.ForceQuitVisualizeEffect();
    }
}
